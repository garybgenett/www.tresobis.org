...
override COMPOSER_EXPORTS := CNAME README.markdown .nojekyll .composer.mk .composer.yml _header.md.cms _header-pages.md.cms _footer-pages.md.cms _footer.md.cms *.html *.pdf *.epub *.revealjs.html *.docx *.pptx *.txt *.md.txt
